                ...
                <v-layout row wrap :class="{'fill-height': $vuetify.breakpoint.mdAndUp}">
                    ...
                    <v-flex lg9 md8 sm12 pa-3>
                        ...
                        <router-view v-cloak>
                            ...
                            <h6 style="margin-top:100px;margin-bottom: 30px;">Made with <span style="color:deeppink">❤</span> by <a target="_blank" href="https://github.com/TheShrug" title="Github profile"> | <a href="mailto:webmaster@speedrunwr.com" title="Email Me">Contact</a></h6>
                        </router-view>
                    </v-flex>
                </v-layout>
            </v-container>
