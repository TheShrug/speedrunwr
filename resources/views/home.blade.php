                ...
                <v-layout row wrap :class="{'fill-height': $vuetify.breakpoint.mdAndUp}">
                    ...
                    <v-flex lg9 md8 sm12 pa-3>
                        ...
                        <router-view v-cloak>
                            ...
                            <h6 style="margin-top:100px;margin-bottom: 30px;"><a target="_blank" href="https://github.com/TheShrug/speedrunwr">Made with <span style="color:deeppink">❤</span></a> | <span title="Reach out on Discord">Discord: <code>theshrug</code></span></h6>
                        </router-view>
                    </v-flex>
                </v-layout>
            </v-container>
